...
import img from '../assets/Group 481961.png';
    ...
    return(
        <div className='div'>
            ...
            <div className="testimonials-heading">
                ...
                <img src= {line} alt=""  className="img-logo"   style={{rotate:"90deg", width:"30px",marginTop:"100px",alignItems:"center", marginLeft:"-350px" }} />
                </div>
              ...
              <div  className='image-body'>
                ...
                <div  className='para-body'>
                    ...
                    <img src= {group1}alt=""   className='colon-img'  style={{marginBottom:"100px", marginRight:"10px"}} />
                    ...
                    <img src= {group}alt=""   className='colon-img'  style={{marginTop:"100px", marginLeft:"10px"}}  />
                </div>
            </section>
...
<div className="heading">
    <h3>Contact Us</h3>
    <img src= {line}  alt=""  className="img-logo"   style={{rotate:"90deg", width:"30px",marginTop:"-80px",alignItems:"center",marginRight:"20px"}} />
     </div>
